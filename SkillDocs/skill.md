...
- [重新认识构造函数、原型和原型链(备用)](https://blog.csdn.net/chern1992/article/details/106785480)
- [JavaScript深入之从原型到原型链](https://github.com/mqyqingfeng/blog/issues/2)
- [JavaScript深入之从原型到原型链(备用)](https://zhuanlan.zhihu.com/p/33071012?from_voters_page=true)
...
- [Tasks, microtasks, queues and schedules--翻译](https://hongfanqie.github.io/tasks-microtasks-queues-and-schedules/)
